  ...
  return (
    <Box sx={{ width: '100%', height: '100%', overflowY: 'initial', backgroundImage: 'url(/images/Gran_Bar.jpeg)', paddingTop: 10, paddingBottom: 7, display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, backgroundColor: 'darkred', padding: 0, zIndex: 1, display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Link to="/Cart">
          <img src="/images/cart.png" alt="Cart" width="50" height="24" />
...
const itemData = [
  {
    id: 1,
    img: '/images/Canadian whiskey.jpeg',
    title: 'Canadian',
  ...
  {
    id: 2,
    img: '/images/Buchanan’s Scotch Whisky.jpeg',
    title: 'Scotch',
  ...
  {
    id: 3,
    img: '/images/Knob Creek Bourbon Whiskey.jpeg',
    title: 'Bourbon',
  ...
  {
    id: 4,
    img: '/images/The Glenlivet Scotch Whisky.jpeg',
    title: 'Scotch',
  ...
  { 
    id: 5,
    img: '/images/Southern Comfort American Whisky.jpeg',
    title: 'Bourbon',
  ...
  {
    id: 7,
    img: '/images/Black Velvet Canadian Whisky.jpeg',
    title: 'Canadian',
  ...
  { 
    id: 8,
    img: '/images/Seagram’s 7 Crown American Whiskey .jpeg',
    title: 'Bourbon',
  ...
  { 
    id: 9,
    img: '/images/Woodford Reserve Bourbon Whiskey.jpeg',
    title: 'Bourbon',
  ...
  { 
    id: 10,
    img: '/images/Johnnie Walker Scotch Whisky.jpeg',
    title: 'Scotch',
  ...
  { 
    id: 11,
    img: '/images/Evan Williams Bourbon Whiskey.jpeg',
    title: 'Bourbon',
  ...
  { 
    id: 12,
    img:'/images/Bulleit Bourbon Whiskey.jpeg',
    title: 'Bourbon',
  ...
  { 
    id: 13,
    img: '/images/Wild Turkey Bourbon Whiskey.jpeg',
    title: 'Bourbon',
  ...
  { 
    id: 14,
    img: '/images/Maker’s Mark Bourbon Whisky.jpeg',
    title: 'Bourbon',
    author: 'Markers Mark',
    price: 24.99
  },
  { 
    id: 15,
    img: '/images/Jack Daniel’s Tennessee Whiskey.jpeg',
    title: 'Tennessee',
  ...
  {
    id: 16,
    img: '/images/Jameson Irish Whiskey.jpeg',
    title: 'Irish',
